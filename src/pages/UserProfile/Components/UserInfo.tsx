        ...
        <UserInfoContainer>
            ...
            <UserInfoList>
                <UserInfoItem
                    id='legalName'
                    title='Tên pháp lý'
                    subtitle={user?.name === "string" || user?.name.length == 0 ? 'Chưa được cung cấp' : user?.name}
                ...
                <UserInfoItem
                    id='email'
                    title='Địa chỉ email'
                    subtitle={user?.email === "string" || user?.email.length == 0 ? 'Chưa được cung cấp' : user?.email}
                ...
                <UserInfoItem
                    id='phone'
                    title='Số điện thoại'
                    subtitle={user?.phone === "string" || user?.phone.length == 0 ? 'Chưa được cung cấp' : user?.phone}
